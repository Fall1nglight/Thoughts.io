...
const { searchMethods } = adminUsers
const { searchParams } = storeToRefs(adminUsers)
      ...
      <form @submit.prevent="handleSubmit">
        ...
        <div class="mb-3 col-6">
          <select class="form-select" v-model="searchOption">
            ...
            <option :value="searchMethods.username">Load by username</option>

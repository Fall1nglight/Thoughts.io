...
public class GetUserGrowthStats : IEndpoint
{
    public static void Map(IEndpointRouteBuilder builder)
    {
        builder
            .MapGet("/growth", Handle)
            .WithSummary("Gets user growth stats for a given peroid of time")
    ...
    public record Response(List<DataPoint> Registrations);

...
namespace ThoughtsApp.Api.Migrations
{
    ...
    [Migration("20251103142306_AddComments")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ThoughtsApp.Api.Data.Tokens.RefreshToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ThoughtsApp.Api.Data.Users.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ThoughtsApp.Api.Data.Users.UserRole", b =>
                {
                    b.Property<Guid>("UserId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ThoughtsApp.Api.Data.Users.UserRole", b =>
                {
                    b.HasOne("ThoughtsApp.Api.Data.Users.Role", "Role")
                        .WithMany()
